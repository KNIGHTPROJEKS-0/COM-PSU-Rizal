...
import { Card, CardContent, CardHeader, CardTitle } from '@com-psu-rizal/ui/ui/card';
import { Button } from '@com-psu-rizal/ui/ui/button';
import { Input } from '@com-psu-rizal/ui/ui/input';
import { Label } from '@com-psu-rizal/ui/ui/label';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@com-psu-rizal/ui/ui/tabs';
import { Badge } from '@com-psu-rizal/ui/ui/badge';
import { Controller } from 'react-hook-form';

// Import Angular Next features
import { useAngularForm, Validators } from '@com-psu-rizal/shared/angular-next/forms';
import { useAngularRouter } from '@com-psu-rizal/shared/angular-next/routing';
import {
  Component as AngularComponent,
  Input as AngularInput,
  Output as AngularOutput,
  HostListener as AngularHostListener,
} from '@com-psu-rizal/shared/angular-next/components';
