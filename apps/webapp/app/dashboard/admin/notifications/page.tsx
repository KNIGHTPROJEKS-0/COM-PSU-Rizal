      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <p>Notification list will be displayed here.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Send new notifications</CardDescription>
            </CardHeader>
            <CardContent>
              <p>Notification creation form will be displayed here.</p>
            </CardContent>
          </Card>
