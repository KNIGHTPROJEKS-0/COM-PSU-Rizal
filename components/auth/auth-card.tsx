...
import { X, Mail, ChevronDown, Eye, EyeOff, User, GraduationCap, School } from "lucide-react"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="bg-black/20 backdrop-blur-sm border border-white/10 rounded-2xl h-14 text-white placeholder:text-white/40 focus:border-white/30 focus:ring-0 text-base transition-all duration-200 hover:bg-black/30 focus:bg-black/30 pl-12"
